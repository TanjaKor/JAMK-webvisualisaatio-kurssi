  ...
  var a = function a(_a, n) {
    var r,
      ...
      var t,
          ...
          c,
          u,
          f = e("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu"),
      ...
      if (n.widgetParent) t = n.widgetParent.append(y);else if (_a.is("input")) t = _a.after(y).parent();else {
        if (n.inline) return void (t = _a.append(y));
        t = _a, _a.children().first().after(y);
      }
      if ("auto" === o && (o = i.top + 1.5 * y.height() >= e(window).height() + e(window).scrollTop() && y.height() + _a.outerHeight() < i.top ? "top" : "bottom"), "auto" === s && (s = t.width() < i.left + y.outerWidth() / 2 && i.left + y.outerWidth() > e(window).width() ? "right" : "left"), "top" === o ? y.addClass("top").removeClass("bottom") : y.addClass("bottom").removeClass("top"), "right" === s ? y.addClass("pull-right") : y.removeClass("pull-right"), "static" === t.css("position") && (t = t.parents().filter(function () {
      ...
      if (P()) {
        for (l.eq(0).find("span").attr("title", n.tooltips.prevMonth), l.eq(1).attr("title", n.tooltips.selectMonth), l.eq(2).find("span").attr("title", n.tooltips.nextMonth), d.find(".disabled").removeClass("disabled"), l.eq(1).text(i.format(n.dayViewHeaderFormat)), B(i.clone().subtract(1, "M"), "M") || l.eq(0).addClass("disabled"), B(i.clone().add(1, "M"), "M") || l.eq(2).addClass("disabled"), a = i.clone().startOf("M").startOf("w").startOf("d"), s = 0; s < 42; s++) {
          0 === a.weekday() && (o = e("<tr>"), n.calendarWeeks && o.append('<td class="cw">' + a.week() + "</td>"), p.push(o)), c = ["day"], a.isBefore(i, "M") && c.push("old"), a.isAfter(i, "M") && c.push("new"), a.isSame(r, "d") && !h && c.push("active"), B(a, "d") || c.push("disabled"), a.isSame(M(), "d") && c.push("today"), 0 !== a.day() && 6 !== a.day() || c.push("weekend"), I({
            type: "dp.classify",
            date: a,
            classNames: c
        ...
        d.find("tbody").empty().append(p), u = y.find(".datepicker-months"), f = u.find("th"), m = u.find("tbody").find("span"), f.eq(0).find("span").attr("title", n.tooltips.prevYear), f.eq(1).attr("title", n.tooltips.selectYear), f.eq(2).find("span").attr("title", n.tooltips.nextYear), u.find(".disabled").removeClass("disabled"), B(i.clone().subtract(1, "y"), "y") || f.eq(0).addClass("disabled"), f.eq(1).text(i.year()), B(i.clone().add(1, "y"), "y") || f.eq(2).addClass("disabled"), m.removeClass("active"), r.isSame(i, "y") && !h && m.eq(r.month()).addClass("active"), m.each(function (t) {
          ...
          for (t.eq(0).find("span").attr("title", n.tooltips.prevDecade), t.eq(1).attr("title", n.tooltips.selectDecade), t.eq(2).find("span").attr("title", n.tooltips.nextDecade), e.find(".disabled").removeClass("disabled"), n.minDate && n.minDate.isAfter(a, "y") && t.eq(0).addClass("disabled"), t.eq(1).text(a.year() + "-" + o.year()), n.maxDate && n.maxDate.isBefore(o, "y") && t.eq(2).addClass("disabled"); !a.isAfter(o, "y");) {
            s += '<span data-action="selectYear" class="year' + (a.isSame(r, "y") && !h ? " active" : "") + (B(a, "y") ? "" : " disabled") + '">' + a.year() + "</span>", a.add(1, "y");
          }
          ...
          for (o.eq(0).find("span").attr("title", n.tooltips.prevCentury), o.eq(2).find("span").attr("title", n.tooltips.nextCentury), a.find(".disabled").removeClass("disabled"), (s.isSame(t({
            ...
            e = s.year() + 12, p = n.minDate && n.minDate.isAfter(s, "y") && n.minDate.year() <= e, c = n.maxDate && n.maxDate.isAfter(s, "y") && n.maxDate.year() <= e, u += '<span data-action="selectDecade" class="decade' + (r.isAfter(s) && r.year() <= e ? " active" : "") + (B(s, "y") || p || c ? "" : " disabled") + '" data-selection="' + (s.year() + 6) + '">' + (s.year() + 1) + " - " + (s.year() + 12) + "</span>", s.add(12, "y");
          }
      ...
      s || (t = y.find(".timepicker [data-action=togglePeriod]"), a = r.clone().add(r.hours() >= 12 ? -12 : 12, "h"), t.text(r.format("A")), B(a, "h") ? t.removeClass("disabled") : t.addClass("disabled")), o.filter("[data-time-component=hours]").text(r.format(s ? "HH" : "hh")), o.filter("[data-time-component=minutes]").text(r.format("mm")), o.filter("[data-time-component=seconds]").text(r.format("ss")), function () {
        ...
        for (i.hour() > 11 && !s && a.hour(12); a.isSame(i, "d") && (s || i.hour() < 12 && a.hour() < 12 || i.hour() > 11);) {
          a.hour() % 4 == 0 && (r = e("<tr>"), n.push(r)), r.append('<td data-action="selectHour" class="hour' + (B(a, "h") ? "" : " disabled") + '">' + a.format(s ? "HH" : "hh") + "</td>"), a.add(1, "h");
        }

        t.empty().append(n);
      }(), function () {
        for (var t = y.find(".timepicker-minutes table"), a = i.clone().startOf("h"), r = [], o = e("<tr>"), s = 1 === n.stepping ? 5 : n.stepping; i.isSame(a, "h");) {
          a.minute() % (4 * s) == 0 && (o = e("<tr>"), r.push(o)), o.append('<td data-action="selectMinute" class="minute' + (B(a, "m") ? "" : " disabled") + '">' + a.format("mm") + "</td>"), a.add(s, "m");
        }

        t.empty().append(r);
      }(), function () {
        for (var t = y.find(".timepicker-seconds table"), a = i.clone().startOf("m"), n = [], r = e("<tr>"); i.isSame(a, "m");) {
          a.second() % 20 == 0 && (r = e("<tr>"), n.push(r)), r.append('<td data-action="selectSecond" class="second' + (B(a, "s") ? "" : " disabled") + '">' + a.format("ss") + "</td>"), a.add(5, "s");
        }
      ...
      y && (j(), A());
        ...
        L = function L(e) {
      var t = h ? null : r;
      if (!e) return h = !0, o.val(""), _a.data("date", ""), I({
        type: "dp.change",
        date: !1,
        oldDate: t
      }), void F();
      if (e = e.clone().locale(n.locale), T() && e.tz(n.timeZone), 1 !== n.stepping) for (e.minutes(Math.round(e.minutes() / n.stepping) * n.stepping).seconds(0); n.minDate && e.isBefore(n.minDate);) {
        e.add(n.stepping, "minutes");
      }
      B(e) ? (i = (r = e).clone(), o.val(r.format(d)), _a.data("date", r.format(d)), h = !1, F(), I({
        type: "dp.change",
        date: r.clone(),
        oldDate: t
      })) : (n.keepInvalid ? I({
      ...
      for (t in x[l] = "p", x) {
        x.hasOwnProperty(t) && "p" === x[t] && (s.push(t), parseInt(t, 10) !== l && (d[t] = !0));
      }
    ...
    if (f.destroy = function () {
      W(), o.off({
        ...
        focus: R
      }) : m && (m.off("click", Q), m.off("mousedown", !1)), _a.removeData("DateTimePicker"), _a.removeData("date");
    ...
    if (_a.hasClass("input-group") && (m = 0 === _a.find(".datepickerbutton").length ? _a.find(".input-group-addon") : _a.find(".datepickerbutton")), !n.inline && !o.is("input")) throw new Error("Could not initialize DateTimePicker without an input element");
    return r = M(), i = r.clone(), e.extend(!0, n, (u = {}, (c = _a.is("input") || n.inline ? _a.data() : _a.find("input").data()).dateOptions && c.dateOptions instanceof Object && (u = e.extend(!0, u, c.dateOptions)), e.each(n, function (e) {
